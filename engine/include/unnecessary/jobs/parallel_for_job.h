...
namespace un {
    ...
    public:
        ParallelizeJob(un::ParallelForJob *parallelForJob, size_t fromIndex, size_t toIndex) : parallelForJob(
                parallelForJob), fromIndex(fromIndex), toIndex(toIndex) {}
    ...
    public:
        ...
        void schedule(un::JobSystem *system, size_t numEntries, size_t minNumberLoopsPerThread = 64);
    };
}
