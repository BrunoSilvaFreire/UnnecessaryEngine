...
namespace un {
    ...
    class VulkanQueueAvailableRequirement : public ARequirement<std::vector<vk::QueueFamilyProperties>> {
    private:
    ...
    class VulkanDeviceTypeRequirement  : public ARequirement<vk::PhysicalDeviceProperties> {
    private:
